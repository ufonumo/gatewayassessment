...
class Designer extends Component {
  ...
  newObject(event) {
    ...
    let {
      meta
    } = this.getObjectComponent(selectedTool);
    let mouse = this.getMouseCoords(event);
    ...
    localStorage.setItem('recent_objects', JSON.stringify(objects));
    ...
    this.setState({
      ...
      selectedTool: null,
      currentObjectIndex: retrievedObject.length,
      objects: retrievedObject.length,
    });
  }
  ...
  detectOverlappedObjects(event) {
    ...
    keys
      ...
      .forEach((key) => {
        ...
        let isOverlapped = mouse.x > left && mouse.x < left + width && mouse.y > top && mouse.y < top + height && currentRect.width > width && currentRect.height > height;
  ...
  renderSVG() {
    ...
    return ( <
      ...
      onRender = {
        (ref) => (this.svgElement = ref)
      }
      onMouseDown = {
        this.newObject.bind(this)
      }
      />
    );
  }
  ...
  render() {
    ...
    return ( <
      ...
      style = {
        styles.keyboardManager
      }
      handlers = {
        this.getKeymapHandlers()
      } >
      <
      div className = {
        'container'
      ...
      onMouseUp = {
        ...
        InsertMenuComponent && < InsertMenuComponent tools = {
          objectTypes
        }
        currentTool = {
          selectedTool
      ...
      div style = {
        ...
        isEditMode && ObjectEditor && ( <
          ...
          onUpdate = {
            (object) => this.updateObject(selectedObjectIndex, object)
          }
          onClose = {
            () =>
            this.setState({
        ...
        showHandler && ( <
          ...
          canRotate = {
            _(currentObject).has('rotate')
          }
          onMouseLeave = {
            this.hideHandler.bind(this)
          }
          onDoubleClick = {
            this.showEditor.bind(this)
          }
          onDrag = {
            this.startDrag.bind(this, modes.DRAG)
          }
          onResize = {
            this.startDrag.bind(this, modes.SCALE)
          }
          onRotate = {
            this.startDrag.bind(this, modes.ROTATE)
          }
          />
        )
      } {
      ...
      showPropertyPanel && < PanelList id = {
        this.props.id
      }
      object = {
        objectWithInitial
      ...
      onArrange = {
        this.handleArrange.bind(this)
      }
      onChange = {
        this.handleObjectChange.bind(this)
      }
      objectComponent = {
        objectComponent
      }
