...
export default class StylePanel extends Component {
  ...
  render() {
    ...
    return ( <
      ...
      onChange = {
        this.props.onChange.bind(this, 'fill')
      }
      /> <
      /Column> <
      /Columns> <
      ...
      onChange = {
        this.props.onChange.bind(this, 'stroke')
      }
      /> <
      /Column> <
      Column label = 'width' >
      ...
      onChange = {
        (e) => this.props.onChange('strokeWidth', e.target.value)
      }
      value = {
        object.strokeWidth
      }
      ...
      onChange = {
        (e) => this.props.onChange('radius', e.target.value)
      }
      value = {
        object.radius
      }
      ...
      onChange = {
        (e) => this.props.onChange('blendmode', e.target.value)
      } > {
        this.modes.map((mode) => ( <
          option key = {
            mode
